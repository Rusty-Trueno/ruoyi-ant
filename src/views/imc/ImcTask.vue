  ...
  <a-card :bordered="false">
    ...
    >
        ...
        <span slot="action" slot-scope="text, record">
            <template>
            <a @click="handleEdit(record)">巡检日志</a>
...
import { getAllPartyAImcTask, transformList } from '@/api/imc'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return getAllPartyAImcTask(Object.assign(parameter, this.queryParam))
          .then(res => {
